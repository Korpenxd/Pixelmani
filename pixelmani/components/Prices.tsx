...
export default function PriserPage() {
  return (
    <>
      <Navbar />
      <main style={{ minHeight: '100vh', background: '#000000', color: '#fff', paddingTop: '5rem' }}>
        <div style={{ padding: 'clamp(3rem, 6vw, 6rem) clamp(1.5rem, 5vw, 4rem)', maxWidth: '1100px', margin: '0 auto' }}>
